...
void MainWindow::on_pushButton_clicked()
{
    ...
    Shader shader(
                QString(strshader+"5.1.framebuffers.vs").toStdString().c_str(),
                QString(strshader+"5.1.framebuffers.fs").toStdString().c_str());
    Shader screenShader(
                QString(strshader+"5.1.framebuffers_screen.vs").toStdString().c_str(),
                QString(strshader+"5.1.framebuffers_screen.fs").toStdString().c_str());
