...
/*
    *scene = (Scene *)malloc(sizeof(Scene));
    ...
    (*scene)->objects[1].type = 0; // Sphere
    (*scene)->objects[1].pos = glm::vec3(10, 0, 20);
    (*scene)->objects[1].rot = glm::vec3(0, 0, 0);
    (*scene)->objects[1].color = glm::vec4(0.2, 0.2, 1, 1);
    (*scene)->objects[1].radius = 5;
    (*scene)->objects[1].diffuse = 1;
    (*scene)->objects[1].specular = 3;
    (*scene)->objects[1].shininess = 50;
    (*scene)->objects[1].reflect = 0.5;


    (*scene)->objects[2].type = 1; // Plane
    (*scene)->objects[2].pos = glm::vec3(0, -3, 0);
    (*scene)->objects[2].rot = glm::vec3(0, 0, 0);
    (*scene)->objects[2].color = glm::vec4(1, 1, 1, 1);
    (*scene)->objects[2].diffuse = 1;
    (*scene)->objects[2].specular = 1;
    (*scene)->objects[2].shininess = 30;
    (*scene)->objects[2].reflect = 0.5;

    (*scene)->nb_lights = 1;
    (*scene)->lights = (Light *)malloc(sizeof(Light) * (*scene)->nb_lights);
    (*scene)->lights[0].pos = glm::vec3(10, 0, 0);
    (*scene)->lights[0].color = glm::vec4(1, 1, 1, 1);
*/
}
